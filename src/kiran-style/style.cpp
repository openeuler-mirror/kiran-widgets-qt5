...
#include "draw-helper/draw-frame-helper.h"
#include "draw-helper/draw-line-edit-helper.h"
#include "draw-helper/draw-button-helper.h"
#include "draw-helper/draw-spinbox-helper.h"
...
#include "draw-helper/draw-tab-bar-helper.h"
    ...
    if (QComboBox *comboBox = qobject_cast<QComboBox *>(widget)) {
        ...
        if (itemView && itemView->itemDelegate() &&
           (itemView->itemDelegate()->inherits("QComboBoxDelegate") || itemView->itemDelegate()->inherits("QComboMenuDelegate")) ) {
            itemView->setItemDelegate(new ComboBoxItemDelegate(comboBox,comboBox));
        }
    }
